...
//   return (
//     <div className="min-h-screen flex flex-col bg-gradient-to-b from-[#A3DE0] to-[#F4F4F4] text-gray-800 ">
//       {/* Header */}
...
//       {/* Footer */}
//       <footer className="bg-[#4C41AF] text-white py-4 text-center shadow-md">
